...
import com.arun.Restaurantbackend.Entity.IdempotencyKey;
...
public class SubscriptionService {
   ...
   private final UserRepo userRepo;
    ...
    @Transactional
    public Subscription processCheckout(String idempotencyKey, Long userId, Long planId) {

        User user=userRepo.findById(userId).orElseThrow(()-> new BadRequestException("User id does not match"));
    ...
    public void cancelUserSubscription(Long id){
        Subscription sub=subRepo.findById(id).orElseThrow(()-> new BadRequestException("Subscription is not found"));
